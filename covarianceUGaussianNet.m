function [sortedLambdasAfterProj, UcovarianceXU, B, err] = covarianceUGaussianNet(C, discreteTime, maximumIterations, forcePowerSeriesForSymmetric, verbose, skipEigsCalculateAndCheck)
%
...
if (~skipEigsCalculateAndCheck)
    ...
    sortedLambdasAfterProj = []; % Not required for this call
end
