...
parameters.weightTheNetworkFunction = 'weightNetworkStandardWithFixedDelay';

% - delay_fixedCross - a fixed cross-coupling delay, utilised for the
% weightNetworkStandardWithFixedDelay option above (only defined for
