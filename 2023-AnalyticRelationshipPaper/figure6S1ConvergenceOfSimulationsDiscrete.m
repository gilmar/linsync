...
print('-depsc', [parameters.folder, '/figS2.eps'])
saveas(gca, [parameters.folder, '/figS2.fig'], 'fig');

fprintf('Figure S2 finished, using %d network samples (is this the same as the 2000 used for the paper?)\n', ...
    parameters.repeats);
